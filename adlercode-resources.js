(() => {
  ...
  resources.push(
    {
      id: "book-lead-by-example",
      titel: "Lead by Example",
      beschreibung: "Band 1 der Adlercode-Reihe über Verantwortung, klare Haltung, Adlerlogik und proaktives Handeln.",
      typ: "Buch",
      kategorie: "Musteranalyse",
      themen: ["Adlersystem", "Verantwortung", "Führung"],
      experte: "musteranalyse-experte",
      kostenlosOderKostenpflichtig: "Kostenpflichtig",
      sprache: "Deutsch",
      dateiOderLink: "buecher/",
      empfohlen: true,
      datum: "2026-06-01",
      tags: ["Adlersystem", "Verantwortung", "Führung"],
    },
    {
      id: "book-masks-vs-claws",
      titel: "Masks vs. Claws",
      beschreibung: "Band 2 über Masken, Covert-Muster, Identität, Systemrollen und verdeckte Dynamiken.",
      typ: "Buch",
      kategorie: "Musteranalyse",
      themen: ["Covert", "Identität", "Masken-ID"],
      experte: "musteranalyse-experte",
      kostenlosOderKostenpflichtig: "Kostenpflichtig",
      sprache: "Deutsch",
      dateiOderLink: "buecher/",
      empfohlen: true,
      datum: "2026-06-02",
      tags: ["Covert", "Identität", "Schlangensystem"],
    },
    {
      id: "book-force-of-nature",
      titel: "Force of Nature",
      beschreibung: "Band 3 vertieft NPC, emotionale Dominanz, Identität, Narrative und Rollenprogramme.",
      typ: "Buch",
      kategorie: "Musteranalyse",
      themen: ["NPC-System", "Narrativanalyse", "Moral"],
      experte: "musteranalyse-experte",
      kostenlosOderKostenpflichtig: "Kostenpflichtig",
      sprache: "Deutsch",
      dateiOderLink: "buecher/",
      empfohlen: true,
      datum: "2026-06-03",
      tags: ["NPC-System", "Narrative", "Moral"],
    },
    {
      id: "book-npc-filter",
      titel: "Setz die Brille auf! - NPC-Filter",
      beschreibung: "Band 4 über NPC-Filter, Programmwechsel, Maskenspiel und Narrativkontrolle.",
      typ: "Buch",
      kategorie: "Wahrnehmung",
      themen: ["NPC-Filter", "Programmwechsel", "Narrativkontrolle"],
      experte: "musteranalyse-experte",
      kostenlosOderKostenpflichtig: "Kostenpflichtig",
      sprache: "Deutsch",
      dateiOderLink: "buecher/",
      empfohlen: true,
      datum: "2026-06-04",
      tags: ["NPC-Filter", "Programmwechsel", "Narrativkontrolle"],
    },
    {
      id: "book-adler-system",
      titel: "Adler-System",
      beschreibung: "Band 5 verbindet Programme, Moral, Filter und Weltbilder zu einem größeren Adlercode-Modell.",
      typ: "Buch",
      kategorie: "Musteranalyse",
      themen: ["Adlersystem", "Moralpyramide", "Filteranalyse"],
      experte: "musteranalyse-experte",
      kostenlosOderKostenpflichtig: "Kostenpflichtig",
      sprache: "Deutsch",
      dateiOderLink: "buecher/",
      empfohlen: true,
      datum: "2026-06-05",
      tags: ["Adlersystem", "Moral", "Filteranalyse"],
    },
    {
